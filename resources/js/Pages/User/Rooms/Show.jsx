...
import { ArrowRight, BedDouble, Users, CalendarDays } from "lucide-react";

export default function Show({ room, booking }) {
                        ...
                        <div>
                            ...
                            >
                                ...
                                {user ? (
                                    ...
                                    <Link
                                        href="/login"
                                        className="mt-6 flex w-full items-center justify-center rounded-xl bg-[#C9A227] px-5 py-3 font-bold text-white"
                                    >
                                        برای رزرو وارد شوید
                                    </Link>
                                )}
