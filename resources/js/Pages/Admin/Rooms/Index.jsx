...
export default function Index({ rooms = [] }) {
    ...
    const changeStatus = (room, operationalStatus) => {
        router.patch(
    ...
    const filteredRooms =
        filter === "all"
            ? rooms
            : rooms.filter((room) => room.current_status === filter);
                ...
                <table className="w-full min-w-[1000px] text-right">
                    ...
                    <tbody>
                        {filteredRooms.map((room) => {
                            const status = statuses[room.current_status] ?? {
                                text: "نامشخص",
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="p-4">{room.title}</td>

                                    <td className="p-4">{room.type}</td>

                                    <td className="p-4">{room.capacity} نفر</td>
